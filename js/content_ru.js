...
const contentRu = {
  ...
  about: {
    title: 'Обо мне',
    text: 'Backend-разработчик с более чем 5-летним опытом создания надёжных высоконагруженных систем на Java и Go. Специализируюсь на проектировании микросервисной архитектуры, асинхронной интеграции сервисов через Kafka и оптимизации работы с PostgreSQL. Работал в финтехе и на бирже, где особенно важны производительность, отказоустойчивость и внимание к деталям. Люблю разбираться в сложных технических задачах и делиться опытом с командой. Всегда открыт к изучению новых технологий и подходов.'
  },
  experience: {
    title: 'Опыт работы',
    jobs: [
